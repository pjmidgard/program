...
print("Program that control computer (control program). By this program you can control computer by eyes. I enjoy writing programs. I like writing programs. I came up with this program.")
